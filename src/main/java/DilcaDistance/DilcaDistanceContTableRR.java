...
public class DilcaDistanceContTableRR implements DistanceFunction, Serializable{
	...
	public DilcaDistanceContTableRR(){
	...
	public DilcaDistanceContTableRR(double epsilon){
		matricesDilca = new Vector<double[][]>();
		m_Disc = new weka.filters.unsupervised.attribute.Discretize();
		m_RepMissValue = new ReplaceMissingValues();
		supDiscr = false;
	...
	public DilcaDistanceContTableRR(double epsilon, long rand){
		matricesDilca = new Vector<double[][]>();
		m_Disc = new weka.filters.unsupervised.attribute.Discretize();
		m_RepMissValue = new ReplaceMissingValues();
		supDiscr = false;
