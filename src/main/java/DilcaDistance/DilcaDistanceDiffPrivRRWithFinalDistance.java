...
public class DilcaDistanceDiffPrivRRWithFinalDistance extends DilcaDistance implements DistanceFunction, Serializable {
	...
	public DilcaDistanceDiffPrivRRWithFinalDistance(){
	...
	public DilcaDistanceDiffPrivRRWithFinalDistance(double epsilonContext, double epsilonDistance){
		matricesDilca = new Vector<double[][]>();
		m_Disc = new weka.filters.unsupervised.attribute.Discretize();
		m_RepMissValue = new ReplaceMissingValues();
		supDiscr = false;
	...
	public DilcaDistanceDiffPrivRRWithFinalDistance(double epsilonContext, double epsilonDistance, long rand){
		matricesDilca = new Vector<double[][]>();
		m_Disc = new weka.filters.unsupervised.attribute.Discretize();
		m_RepMissValue = new ReplaceMissingValues();
		supDiscr = false;
