 ...
 * @version $Revision$
 */
public class AttributeSelectionMean implements Serializable, RevisionHandler {
  ...
  public void SelectAttributes(Instances data) throws Exception {
    ...
    //attrinutSet restituisce l'indice degli attributi facenti parte del context
    /*
    for (int p = 0; p < attributeSet.length; p++) {
    	System.out.println("ranked attributes FCBF: "+attributeSet[p]);
    ...
    if ((m_searchMethod instanceof RankedOutputSearch) && m_doRank == true) {
     ...
     // m_selectionResults.append("Ranked attributes:\n");
      ...
      //System.out.println("m_numToSelect in attributeselecutio: "+m_numToSelect);
  ...
  //    m_selectionResults.append(CrossValidateAttributes());
    ...
    //System.out.println("m_selectionResults"+m_selectionResults);
  ...
  public static String SelectAttributes(ASEvaluation ASEvaluator,
    ...
    int classIndex = -1;
    boolean helpRequested = false;
    AttributeSelectionMean trainSelector = new AttributeSelectionMean();
