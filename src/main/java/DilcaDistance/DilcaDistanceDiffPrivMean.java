...
public class DilcaDistanceDiffPrivMean extends DilcaDistance implements DistanceFunction, Serializable {
	...
	public DilcaDistanceDiffPrivMean(){
	...
	public DilcaDistanceDiffPrivMean(double epsilon, double sigma){
		matricesDilca = new Vector<double[][]>();
		m_Disc = new weka.filters.unsupervised.attribute.Discretize();
		m_RepMissValue = new ReplaceMissingValues();
		supDiscr = false;
	...
	public DilcaDistanceDiffPrivMean(double epsilon, double sigma, long rand){
		matricesDilca = new Vector<double[][]>();
		m_Disc = new weka.filters.unsupervised.attribute.Discretize();
		m_RepMissValue = new ReplaceMissingValues();
		supDiscr = false;
...
//			System.out.println(reducedData);
	...
	public double SU(Instances data, int indexTarget, int indexAttrCont){
		...
		*/
		System.out.println(ContingencyTablesDiffPriv.mySymmetricalUncertaintyNoised(matrix,epsilon, data.numInstances(), data.attribute(indexTarget).numValues(),data.attribute(indexAttrCont).numValues(), rand));
		return ContingencyTablesDiffPriv.mySymmetricalUncertaintyNoised(matrix,epsilon, data.numInstances(), data.attribute(indexTarget).numValues(),data.attribute(indexAttrCont).numValues(), rand);
