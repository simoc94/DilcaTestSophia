...
public class HepatitisNMIDilcaDiffPrif {
...
public static void main(String[]args) throws Exception {
		...
		dd.setEpsilon(2);
		System.out.println("*******************************************");
		HepatitisNMIDilcaDiffPrif clusterDilca = new HepatitisNMIDilcaDiffPrif();
		...
		//double hYaa = (-(1/6)*((paaa*log2(paaa))+(pbaa*log2(pbaa))+ (pcaa*log2(pcaa))+ (pdaa*log2(pdaa))+(peaa*log2(peaa))+(pfaa*log2(pfaa))));
		  ...
		  System.out.println("Valore di NMI tra cluster definito dalla classe del dataset e cluster definiti da Dilca con DifferentialPrivacy: "+NMI);
	/*	  
