...
public class TitanicDatasetNMIDilcaDiffPriv {
...
public static void main(String[]args) throws Exception {
		...
		System.out.println("*******************************************");
		TitanicDatasetNMIDilcaDiffPriv clusterDilca = new TitanicDatasetNMIDilcaDiffPriv();
		...
		//P(Y=a|C=aa)... a è quando classLabel[i] = 1, mentre aa è quando classCluster è 0
		  ...
		  for(int i=0; i< classCluster.length;i++) {
			  if(classLabel[i] == 0 && classCluster[i] == 0) {
				  aaa++;
			  }else if(classLabel[i] == 1 && classCluster[i] == 0) {
				  aab++;
			  }
		  }
		...
		//ora calcola P(Y=a|C=bb) ecc
		  ...
		  int bbb = 0;
		  for(int i=0; i< classCluster.length;i++) {
			  if(classLabel[i] == 0 && classCluster[i] == 1) {
				  bba++;
			  }else if(classLabel[i] == 1 && classCluster[i] == 1) {
				  bbb++;
			  }
		  }
