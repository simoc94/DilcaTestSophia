...
public class BreastCancerNMIDilcaDiffPrivMean {
...
/*	public static int[] getCluster(DistanceFunction df) throws Exception {
	...
	public static void main(String[] args) throws Exception {
		...
		DataSource ds =  new DataSource("/Users/Simone/eclipse-workspace/Tesi/src/BreastCancerDataset/breast-cancer.csv");
		Instances dataSet = ds.getDataSet();
		int[] classLabel = new int[dataSet.numInstances()];
		int j = 10;
		for(int i = 0; i< dataSet.numInstances(); i++) {
			if(dataSet.get(i).stringValue(j).equals("recurrence-events")) {
				classLabel[i] = 1;
			}else if(dataSet.get(i).stringValue(j).equals("no-recurrence-events")) {
				classLabel[i] = 2;
			}
		...
		dd.setSigma(0.9);
		System.out.println("*******************************************");
		BreastCancerNMIDilcaDiffPrivMean clusterDilca = new BreastCancerNMIDilcaDiffPrivMean();
		clusterDilca.loadArff("/Users/Simone/eclipse-workspace/Tesi/src/BreastCancerDataset/breast-cancer.arff");
		...
		double sigma = 0.0;
		double epsilon = 0.00;
		FileWriter writer = new FileWriter("/Users/Simone/eclipse-workspace/Tesi/src/BreastCancerDataset/BreastCancerMean.txt", true);
		...
		*/
		...
		double epsilon = 0.0;
		double sigma = 0.0;
		FileWriter writer = new FileWriter("/Users/Simone/eclipse-workspace/Tesi/src/BreastCancerDataset/BreastCancerMEAN2.txt", true);
		...
		*/
		...
		double epsilon = 0.5;
		double sigma = 0.0;
		FileWriter writer = new FileWriter("/Users/Simone/eclipse-workspace/Tesi/src/BreastCancerDataset/BreastCancerMEAN3.txt", true);
		for(int ciclo = 1; ciclo<10; ciclo++) {
			epsilon = epsilon+0.5;
			sigma = 0.0;
			for(int ciclosig = 0; ciclosig<10;ciclosig++) {
