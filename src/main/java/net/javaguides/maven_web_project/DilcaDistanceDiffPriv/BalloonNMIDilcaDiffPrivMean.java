...
public class BalloonNMIDilcaDiffPrivMean {
...
/*	public static int[] getCluster(DistanceFunction df) throws Exception {
	...
	public static void main(String[] args) throws Exception {
		...
		DataSource ds =  new DataSource("/Users/Simone/eclipse-workspace/Tesi/src/BalloonDataset/balloons20.csv");
		...
		dd.setSigma(0.1);
		System.out.println("*******************************************");
		BalloonNMIDilcaDiffPrivMean clusterDilca = new BalloonNMIDilcaDiffPrivMean();
		clusterDilca.loadArff("/Users/Simone/eclipse-workspace/Tesi/src/BalloonDataset/balloons20.arff");
		...
		double sigma = 0.0;
		double epsilon = 0.00;
		FileWriter writer = new FileWriter("/Users/Simone/eclipse-workspace/Tesi/src/BalloonDataset/balloonsMean.txt", true);
		...
		*/
		...
		double epsilon = 0.0;
		double sigma = 0.0;
		FileWriter writer = new FileWriter("/Users/Simone/eclipse-workspace/Tesi/src/BalloonDataset/balloonsMEAN2.txt", true);
		...
		*/
		...
		double epsilon = 0.5;
		double sigma = 0.0;
		FileWriter writer = new FileWriter("/Users/Simone/eclipse-workspace/Tesi/src/BalloonDataset/balloonsMEAN3.txt", true);
		for(int ciclo = 1; ciclo<10; ciclo++) {
			epsilon = epsilon+0.5;
			sigma = 0.0;
			for(int ciclosig = 0; ciclosig<10;ciclosig++) {
