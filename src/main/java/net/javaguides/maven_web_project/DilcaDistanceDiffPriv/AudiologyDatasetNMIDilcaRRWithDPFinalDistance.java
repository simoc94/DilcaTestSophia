...
public class AudiologyDatasetNMIDilcaRRWithDPFinalDistance {
...
public static void main(String[]args) throws Exception {
		...
		DilcaDistanceDiffPrivRRWithFinalDistance dd = new DilcaDistanceDiffPrivRRWithFinalDistance(0.1, 0.1);
		System.out.println("*******************************************");
		AudiologyDatasetNMIDilcaRRWithDPFinalDistance clusterDilca = new AudiologyDatasetNMIDilcaRRWithDPFinalDistance();
