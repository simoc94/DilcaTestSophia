...
public class BalloonNMIDilcaDiffPriv {
...
public static void main(String[]args) throws Exception {
		...
		DilcaDistanceDiffPrivRR dd = new DilcaDistanceDiffPrivRR(5);
		System.out.println("*******************************************");
		BalloonNMIDilcaDiffPriv clusterDilca = new BalloonNMIDilcaDiffPriv();
		...
		//double hYaa = (-(1/6)*((paaa*log2(paaa))+(pbaa*log2(pbaa))+ (pcaa*log2(pcaa))+ (pdaa*log2(pdaa))+(peaa*log2(peaa))+(pfaa*log2(pfaa))));
		  ...
		  double Ybb = 0;
		  if(pabb!= 0) {
			  Yaa = Yaa + ((pabb*log2(pabb)));
		  }
		  if(pbbb!= 0) {
			  Yaa = Yaa + ((pbbb*log2(pbbb)));
		  }
...
/*
		  ...
		  double entropyconiditonedonrow1 = (-(0.6)*(((1/3.0)*log2((1/3.0)))+((2/3.0)*log2((2/3.0)))));
		  double entropyconiditonedonrow2 = (-(0.4)*((0.5*log2(0.5))+(0.5*log2(0.5))));
