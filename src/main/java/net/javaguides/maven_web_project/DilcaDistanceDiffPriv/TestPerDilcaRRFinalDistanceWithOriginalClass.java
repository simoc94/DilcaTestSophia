...
public class TestPerDilcaRRFinalDistanceWithOriginalClass {
	...
	public static void main(String[]args) throws Exception {
        ...
        double epsilon = 0.0;
        FileWriter writer1 = new FileWriter("C:\\Users\\Simone\\Desktop\\testDilcaFInalDistanceWithOriginalClass\\TitanicRRDistance1.txt", true);
		...
		writer1.close();
		epsilon = 0.0;
		FileWriter writer2 = new FileWriter("C:\\Users\\Simone\\Desktop\\testDilcaFInalDistanceWithOriginalClass\\TitanicRRDistance2.txt", true);
		for(int ciclo = 1; ciclo<10; ciclo++) {
			epsilon = epsilon+0.1;
			DilcaDistanceDPFinalDistance dd = new DilcaDistanceDPFinalDistance(epsilon);
			dd.setEpsilon(epsilon);
		...
		writer2.close();
		epsilon = 0.5;
		FileWriter writer3 = new FileWriter("C:\\Users\\Simone\\Desktop\\testDilcaFInalDistanceWithOriginalClass\\TitanicRRDistance3.txt", true);
		for(int ciclo = 1; ciclo<10; ciclo++) {
			epsilon = epsilon+0.5;
			DilcaDistanceDPFinalDistance dd = new DilcaDistanceDPFinalDistance(epsilon);
			dd.setEpsilon(epsilon);
