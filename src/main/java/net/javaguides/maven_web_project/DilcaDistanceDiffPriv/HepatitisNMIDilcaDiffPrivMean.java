...
public class HepatitisNMIDilcaDiffPrivMean {
...
/*	public static int[] getCluster(DistanceFunction df) throws Exception {
	...
	public static void main(String[] args) throws Exception {
		...
		dd.setSigma(0.1);
		System.out.println("*******************************************");
		HepatitisNMIDilcaDiffPrivMean clusterDilca = new HepatitisNMIDilcaDiffPrivMean();
		...
		*/
		...
		double sigma = 0.0;
		double epsilon = 0.00;
		FileWriter writer = new FileWriter("C:\\Users\\Simone\\eclipse-workspace\\Tesi\\src\\HepatitisDataset\\HepatitisMEAN.txt", true);
		...
		*/
		...
		double epsilon = 0.0;
		double sigma = 0.0;
		FileWriter writer = new FileWriter("/Users/Simone/eclipse-workspace/Tesi/src/HepatitisDataset/HepatitisMEAN2.txt", true);
		...
		*/
		...
		double epsilon = 0.5;
		double sigma = 0.0;
		FileWriter writer = new FileWriter("/Users/Simone/eclipse-workspace/Tesi/src/HepatitisDataset/HepatitisMEAN3.txt", true);
		for(int ciclo = 1; ciclo<10; ciclo++) {
			epsilon = epsilon+0.5;
			sigma = 0.0;
			for(int ciclosig = 0; ciclosig<10;ciclosig++) {
