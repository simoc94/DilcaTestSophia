...
public class VoteNMIDilcaDiffPrivMean {
...
/*	public static int[] getCluster(DistanceFunction df) throws Exception {
	...
	public static void main(String[] args) throws Exception {
		...
		DataSource ds =  new DataSource("/Users/Simone/eclipse-workspace/Tesi/src/VoteDataset/house-votes-84.csv");

		Instances dataSet = ds.getDataSet();
		int[] classLabel = new int[dataSet.numInstances()];
		int j = 0;
		for(int i = 0; i< dataSet.numInstances(); i++) {
			if(dataSet.get(i).stringValue(j).equals("democrat")) {
				classLabel[i] = 1;
			}else if(dataSet.get(i).stringValue(j).equals("republican")) {
				classLabel[i] = 2;
			}
		...
		dd.setSigma(1);
		System.out.println("*******************************************");
		VoteNMIDilcaDiffPrivMean clusterDilca = new VoteNMIDilcaDiffPrivMean();
		clusterDilca.loadArff("/Users/Simone/eclipse-workspace/Tesi/src/VoteDataset/house-votes-84.arff");
		...
		double sigma = 0.0;
		double epsilon = 0.00;
		FileWriter writer = new FileWriter("/Users/Simone/eclipse-workspace/Tesi/src/VoteDataset/VoteMean.txt", true);
		...
		*/
		...
		double epsilon = 0.0;
		double sigma = 0.0;
		FileWriter writer = new FileWriter("/Users/Simone/eclipse-workspace/Tesi/src/VoteDataset/VoteMEAN2.txt", true);
		...
		*/
		...
		double epsilon = 0.5;
		double sigma = 0.0;
		FileWriter writer = new FileWriter("/Users/Simone/eclipse-workspace/Tesi/src/VoteDataset/VoteMEAN3.txt", true);
		for(int ciclo = 1; ciclo<10; ciclo++) {
			epsilon = epsilon+0.5;
			sigma = 0.0;
			for(int ciclosig = 0; ciclosig<10;ciclosig++) {
