...
public class TestMancanti {
	...
	public static void mushroomAriMatriciInizialiMean() throws Exception {
		Instances cpu = null;
		DataSource source = new DataSource("/home/Celano/Desktop/DilcaTestSophia/target/classes/Test/mushroom.arff");
	    ...
	    String s = "/home/Celano/Desktop/DilcaTestSophia/target/classes/Test/mushroom.arff";
	    ...
	    for(int sig = 0; sig<10;sig++) {
			...
			for(int i = 0; i<20;i++) {
				...
				BalloonNMISoloDilcaTestSuClasseDataset.loadArff("/home/Celano/Desktop/DilcaTestSophia/target/classes/Test/mushroom.arff");
