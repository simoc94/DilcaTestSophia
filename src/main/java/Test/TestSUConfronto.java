...
public class TestSUConfronto {
	public static void main(String[] args) throws Exception {
		...
		*/
		...
		double epsilon = 0.0;
		FileWriter writer = new FileWriter("C:\\Users\\Simone\\Desktop\\TestSU\\Confronto\\Tutti\\MushroomTuttiConfronto.txt", true);
			for(int ciclo = 1; ciclo<500; ciclo++) {
				rand.setSeed(11235813);
				epsilon = epsilon+0.005;
				double valSU = 0.0;
				int attributoTarget = 0;
				for(int po = 0; po< cpu.numAttributes();po++) {
					int attributo = 0;
