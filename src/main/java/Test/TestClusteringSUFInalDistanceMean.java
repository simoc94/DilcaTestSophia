...
public class TestClusteringSUFInalDistanceMean {
...
public static void main(String[]args) throws Exception {
        ...
        for(int sig = 0; sig<10;sig++) {
        	sigma = sigma + 0.1;
        	epsilon = 0.0;
        FileWriter writer1 = new FileWriter("C:\\Users\\Simone\\Desktop\\TestClusteringSUFinalDistMEAN\\MushroomSUFinalDistMean1Sigma"+sigma+".txt", true);
		...
		epsilon = 0.5;
		 for(int sig = 0; sig<10;sig++) {
	        	sigma = sigma + 0.1;
	        	epsilon = 0.5;
				FileWriter writer2 = new FileWriter("C:\\Users\\Simone\\Desktop\\TestClusteringSUFinalDistMEAN\\MushroomSUFinalDistMean2Sigma"+sigma+".txt", true);
				for(int ciclo = 1; ciclo<10; ciclo++) {
					rand.setSeed(11235813);
					epsilon = epsilon+0.5;
					double corr = 0;
