...
public class TestClusteringMatrIniRR {
	...
	public static void main(String[]args) throws Exception {
        ...
        FileWriter writer1 = new FileWriter("C:\\Users\\Simone\\Desktop\\TestClusteringMatrIniRR\\MushroomMatrIniRR1ARI.txt", true);
		...
		epsilon = 0.5;
		FileWriter writer2 = new FileWriter("C:\\Users\\Simone\\Desktop\\TestClusteringMatrIniRR\\MushroomMatrIniRR2ARI.txt", true);
		for(int ciclo = 1; ciclo<10; ciclo++) {
			rand.setSeed(11235813);
			epsilon = epsilon+0.5;
			double corr = 0;
