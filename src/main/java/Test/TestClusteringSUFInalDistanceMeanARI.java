...
public class TestClusteringSUFInalDistanceMeanARI {
...
public static void main(String[]args) throws Exception {
        ...
        for(int sig = 0; sig<10;sig++) {
        	sigma = sigma + 0.1;
        	epsilon = 0.0;
        FileWriter writer1 = new FileWriter("C:\\Users\\Simone\\Desktop\\TestClusteringSUFinalDistMEAN\\ARI\\SoybeanSUFinalDistMean1Sigma"+sigma+"ARI.txt", true);
		for(int ciclo = 1; ciclo<10; ciclo++) {
			...
			for(int i = 0; i<100;i++) {
				...
				int[] classCluster = BalloonNMISoloDilcaTestSuClasseDataset.clusterData(dd, 19);
		...
		epsilon = 0.5;
		 for(int sig = 0; sig<10;sig++) {
	        	sigma = sigma + 0.1;
	        	epsilon = 0.5;
				FileWriter writer2 = new FileWriter("C:\\Users\\Simone\\Desktop\\TestClusteringSUFinalDistMEAN\\ARI\\SoybeanSUFinalDistMean2Sigma"+sigma+"ARI.txt", true);
				for(int ciclo = 1; ciclo<10; ciclo++) {
					rand.setSeed(11235813);
					epsilon = epsilon+0.5;
					double corr = 0;
