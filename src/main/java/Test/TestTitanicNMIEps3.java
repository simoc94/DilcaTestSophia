...
public class TestTitanicNMIEps3 {
...
public static void main(String[]args) throws Exception {
        ...
        for(int sig = 0; sig<10;sig++) {
        	sigma = sigma + 0.1;
        	FileWriter writer1 = new FileWriter("C:\\\\Users\\\\Simone\\\\Desktop\\\\Titanic\\\\TitanicMatrIniNMI"+sigma+".txt", true);
        ...
        for(int sig = 0; sig<10;sig++) {
        	sigma = sigma + 0.1;
        	FileWriter writer1 = new FileWriter("C:\\Users\\Simone\\Desktop\\Titanic\\TitanicSUMeanSigmaNMI"+sigma+"Epsilon3.txt", true);
			rand.setSeed(11235813);
			double corr = 0;
			int counter = 0;
			for(int i = 0; i<20;i++) {
        ...
        FileWriter writer1 = new FileWriter("C:\\Users\\Simone\\Desktop\\Titanic\\TitanicMatrIniRRNMIEps3.txt", true);
		rand.setSeed(11235813);
		double corr = 0;
		int counter = 0;
		for(int i = 0; i<20;i++) {
		...
		FileWriter writer2 = new FileWriter("C:\\Users\\Simone\\Desktop\\Titanic\\TitanicSUFinalDistRRNMIEps3.txt", true);
		rand.setSeed(11235813);
		double corr1 = 0;
		int counter1 = 0;
		for(int i = 0; i<20;i++) {
